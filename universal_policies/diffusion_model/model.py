...
from universal_policies.diffusion_model.utils import transform_sample, state2img
from universal_policies.utils.models import EDM
from universal_policies.utils.networks import ConditionalUnet3DDhariwal
...
class EDMModel(EDM):
    ...
    def on_validation_epoch_end(self):
        ...
        """
        samples, missions, context_types = self.create_conditional_samples(
            self.n_samples
        )
        ...
        while len(missions) < n_samples:
            ...
            if self.context_type == "agent_id":
                ...
                raise NotImplementedError(
                    f"Context type {self.context_type} not implemented"
                )
    ...
    def conditional_sample(self, obs_0, context, label):
        ...
        sample = super().conditional_sample(
            ...
            context,
            label,
            (self.num_frames - 1, self.image_size, self.image_size, self.image_channel),
        )
