...
from universal_policies.environments.babyai.goto_specific import (
    register_envs,
    FIXINSTGOTO_ENVS,
)
...
def generate_episode(
    ...
    if use_img_obs:
        env = RGBImgObsWrapper(env, tile_size=img_size // env.get_wrapper_attr("width"))
    else:
...
def generate_demos(
    ...
    if env == "GOTO" or env == "GOTO_DISTRACTORS":
        ...
        raise NotImplementedError(f"This environment has not been implemented {env}")
